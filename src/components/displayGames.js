...
function Game({ link, name, url }) {
  return (
    <a className="game" href={link} id="game">
      <img src={url} className="img" id="image" alt="Logo" />
...
function DisplayableGames({ opened }) {
  return (
...
DisplayableGames.propTypes = {
  opened: PropTypes.string,
}

export default DisplayableGames
